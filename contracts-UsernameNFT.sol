...
contract UsernameNFT is ERC721, Ownable {
    ...
    // Platform treasury address (Builder's wallet)
    ...
    constructor(address _treasury) ERC721("Names Paired Username", "NAMES") {
     ...
     */
    function buyPairedUsername(uint256 _tokenId) external {
        PairedUsername storage paired = pairedUsernames[_tokenId];
